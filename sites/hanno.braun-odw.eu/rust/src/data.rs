        ...
        Self(vec![
            SideProject {
                ...
                description: Markdown("\
                    ...
                    been working on multiple iterations of it over a few \
                    years, and this is the first public release.\n\n\

                    The goal for this first release was to build enough \
                    infrastructure to support [a simple spacer model]. I plan \
                    to extend it and create more complex models going \
                    forward.\n\n\
            ...
            SideProject {
                ...
                date: "2021-04-06",
                description: Markdown("\
                    I revamped my website (the one you're looking at right \
                    now) and put it on new technical footing, using my own \
                    [homegrown static site generator]. I also got a new domain \
                    and started consolidating most of my IT infrastructure \
                    (including email and Matrix homeserver) under it.\n\n\
            ...
            SideProject {
                ...
                date: "2021-03-05",
                description: Markdown("\
                    [My Boss] is a command-line application that tells me what \
                    to do and when to do it. Kind of like an ERP system, \
                    except that I'm the opposite of an enterprise. This was \
                    the initial release that included contact management \
                    functionality, kind of like a CRM.\n\n\
